...
# Import via the canonical path. Module is at
# blut/python/lamquant/snn/train_mamba_snn.py (also on sys.path via
# blut/python/conftest.py; this insert keeps the file self-contained).
