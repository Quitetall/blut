...
# ============================================================
# WSD Learning Rate Schedule — moved to the scheduler ingredient
# (ADR 0050/0051: lamquant/ingredients/schedules/wsd.py). The SNN
# trainers import it from there now instead of cross-importing from
# this codec trainer.
# ============================================================
from lamquant.ingredients.schedules.wsd import WSDScheduler  # noqa: E402
